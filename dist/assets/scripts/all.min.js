(function() {
  ...
  GameController = function($http, $timeout, cardService, playerService) {
    ...
    game.newGame = function(players_array) {
      var i, id, j, player, ref, ref1, ref2, ref3;
      ...
      if (game.computer_players > 0) {
        for (id = i = 1, ref = game.computer_players; 1 <= ref ? i <= ref : i >= ref; id = 1 <= ref ? ++i : --i) {
      ...
      if (game.human_players > 0) {
        for (id = j = ref1 = 1 + game.computer_players, ref2 = game.human_players + game.computer_players; ref1 <= ref2 ? j <= ref2 : j >= ref2; id = ref1 <= ref2 ? ++j : --j) {
